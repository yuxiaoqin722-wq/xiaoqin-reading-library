...
window.LESSONS['1A-lesson3'] = {
  ...
  readings: {
    A: {
      ...
      translation: 'Hello. My name is Hassan. My name is Wang Xiaolong. My name is Ali.',
    ...
    B: {
      ...
      translation: 'Hello. What is your name? My name is Hassan. And you? My name is Wang Xiaolong.',
    ...
    C: {
      ...
      translation: 'Hello. My name is Hassan. He is Wang Xiaolong. He is Ali. What is your name?',
  ...
  challenge: {
    ...
    translation: 'Hello. My name is ______. His name is ______. What is your name?',
