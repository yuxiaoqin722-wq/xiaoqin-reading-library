...
window.LESSONS['1C-lesson4'] = {
  ...
  readings: {
    A: {
      ...
      translation: "I like singing. I like drawing. I like playing games. I don’t like dancing. / أنا أحب الغناء. أنا أحب الرسم. أنا أحب لعب الألعاب. أنا لا أحب الرقص.",
      tip: 'Reading Goal: Read each sentence 3 times.',
      lines: [
        {
          tokens: [
            { py: 'Wǒ', hz: '我' },
        ...
        },
        {
          ...
          translation: 'I like drawing. / أنا أحب الرسم.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我' },
          ...
          translation: 'I like playing games. / أنا أحب لعب الألعاب.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我' },
    ...
    B: {
      ...
      translation: "What do you like to do? I like singing. Do you like drawing? I like drawing. I don’t like dancing. / ماذا تحب أن تفعل؟ أنا أحب الغناء. هل تحب الرسم؟ أنا أحب الرسم. أنا لا أحب الرقص.",
      ...
      lines: [
        ...
        },
        {
          ...
          translation: 'Do you like drawing? / هل تحب الرسم؟'
        },
        {
          tokens: [
            { py: '', hz: '🧒：', cls: 'speaker' },
    ...
    C: {
      ...
      translation: "My name is Lily. I like singing and drawing. I don’t like playing games. After school, I like singing with my friends. Singing makes me happy. / اسمي ليلي. أنا أحب الغناء والرسم. أنا لا أحب لعب الألعاب. بعد المدرسة، أحب أن أغني مع أصدقائي. الغناء يجعلني سعيدة.",
      ...
      lines: [
        {
          ...
          translation: 'My name is Lily. / اسمي ليلي.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我' },
          ...
          translation: 'I like singing, and I also like drawing. / أنا أحب الغناء، وأحب الرسم أيضًا.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我' },
          ...
          translation: "I don’t like playing games. / أنا لا أحب لعب الألعاب."
        },
        {
          tokens: [
          ...
          translation: 'After school, I like singing with my friends. / بعد المدرسة، أحب أن أغني مع أصدقائي.'
        },
        {
          tokens: [
            { py: 'Chànggē', hz: '唱歌', cls: 'activity' },
          ...
          translation: 'Singing makes me happy. / الغناء يجعلني سعيدة.'
        }
      ]
    }
  },
  ...
  challenge: {
    ...
    translation: "I like ______. I don’t like ______. What do you like to do? / أنا أحب ______. أنا لا أحب ______. ماذا تحب أن تفعل؟",
