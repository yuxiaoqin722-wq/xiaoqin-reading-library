...
window.LESSONS['2A-lesson8'] = {
  ...
  keySentences: [
    ...
    },
    {
      ...
      translation: "I have Chinese class at two o'clock. / لدي درس اللغة الصينية في الساعة الثانية."
    },
    {
      tokens: [
        { py: 'Nǐ', hz: '你', cls: 'person' },
  ...
  readings: {
    A: {
      ...
      translation: "I have Chinese class today. I have math class in the afternoon. I have Chinese class at two o'clock. I have science class in the afternoon. / لدي درس اللغة الصينية اليوم. لدي درس الرياضيات بعد الظهر. لدي درس اللغة الصينية في الساعة الثانية. لدي درس العلوم بعد الظهر.",
      ...
      lines: [
        {
          ...
          translation: 'I have Chinese class today. / لدي درس اللغة الصينية اليوم.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我', cls: 'self' },
          ...
          translation: 'I have math class in the afternoon. / لدي درس الرياضيات بعد الظهر.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我', cls: 'self' },
        ...
        },
        {
          ...
          translation: 'I have science class in the afternoon. / لدي درس العلوم بعد الظهر.'
        }
      ]
    },
    ...
    B: {
      ...
      translation: "What classes do you have today? I have Chinese class today. What time do you have Chinese class? I have Chinese class at two o'clock. I also like Chinese class! / ما الدروس لديك اليوم؟ لدي درس اللغة الصينية اليوم. في أي ساعة لديك درس اللغة الصينية؟ لدي درس اللغة الصينية في الساعة الثانية. أنا أيضًا أحب درس اللغة الصينية!",
    ...
    C: {
      ...
      translation: "I have English class on Monday morning. I have Chinese class on Wednesday afternoon. I have PE class at two o'clock. I like Chinese class. What class do you like? / لدي درس اللغة الإنجليزية صباح يوم الاثنين. لدي درس اللغة الصينية بعد ظهر يوم الأربعاء. لدي درس الرياضة في الساعة الثانية. أنا أحب درس اللغة الصينية. أي درس تحب؟",
      ...
      lines: [
        {
          ...
          translation: 'I have English class on Monday morning. / لدي درس اللغة الإنجليزية صباح يوم الاثنين.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我', cls: 'self' },
          ...
          translation: 'I have Chinese class on Wednesday afternoon. / لدي درس اللغة الصينية بعد ظهر يوم الأربعاء.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我', cls: 'self' },
          ...
          translation: "I have PE class at two o'clock. / لدي درس الرياضة في الساعة الثانية."
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我', cls: 'self' },
  ...
  challenge: {
    ...
    translation: 'I have ______ today. I have ______ at ______. I like ______. What class do you like? / لدي ______ اليوم. لدي ______ في ______. أنا أحب ______. أي درس تحب؟',
  ...
  meanings: {
    ...
    '我两点有中文课': "I have Chinese class at two o'clock. / لدي درس اللغة الصينية في الساعة الثانية.",
    '你喜欢什么课': 'What class do you like? / أي درس تحب؟',
    '我喜欢中文课': 'I like Chinese class. / أنا أحب درس اللغة الصينية.',
    '学': 'study / دراسة'
  }
};