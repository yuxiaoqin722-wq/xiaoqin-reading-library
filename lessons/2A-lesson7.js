...
window.LESSONS['2A-lesson7'] = {
  ...
  readings: {
    A: {
      ...
      translation: 'I am studying. I am watching TV. I am making a phone call. I am playing the piano. / أنا أدرس. أنا أشاهد التلفاز. أنا أتصل هاتفيًا. أنا أعزف البيانو.',
      ...
      lines: [
        ...
        },
        {
          ...
          translation: 'I am watching TV. / أنا أشاهد التلفاز.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我', cls: 'self' },
          ...
          translation: 'I am making a phone call. / أنا أتصل هاتفيًا.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我', cls: 'self' },
          ...
          translation: 'I am playing the piano. / أنا أعزف البيانو.'
        }
      ]
    },
    ...
    B: {
      ...
      translation: 'What are you doing? I am studying. And you? I am making a phone call. / ماذا تفعل؟ أنا أدرس. وأنت؟ أنا أتصل هاتفيًا.',
    ...
    C: {
      ...
      translation: 'Dad is reading. Mom is playing the piano. Grandpa is doing Tai Chi. I am studying. What are you doing? / أبي يقرأ. أمي تعزف البيانو. جدي يمارس تاي تشي. أنا أدرس. ماذا تفعل؟',
      ...
      lines: [
        ...
        },
        {
          ...
          translation: 'Grandpa is doing Tai Chi. / جدي يمارس تاي تشي.'
        },
        {
          tokens: [
            { py: 'Wǒ', hz: '我', cls: 'self' },
  ...
  challenge: {
    ...
    translation: 'I am ______. Dad is ______. Mom is ______. What are you doing? / أنا ______. أبي ______. أمي ______. ماذا تفعل؟',
  ...
  meanings: {
    ...
    '爷爷在打太极拳': 'Grandpa is doing Tai Chi. / جدي يمارس تاي تشي.',
    '想': 'miss / يشتاق',
