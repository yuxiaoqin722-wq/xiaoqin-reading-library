...
window.LESSONS['3B-lesson2'] = {
  ...
  goal: 'Talk about how well someone can do something using 得.',
  ...
  keyWords: [
    ...
    { emoji: '😊', pinyin: 'hěn hǎo', text: '很好', translation: 'very well / جيد جدًا' },
    { emoji: '👍', pinyin: 'búcuò', text: '不错', translation: 'not bad / لا بأس به' },
    { emoji: '🙂', pinyin: 'yìbān', text: '一般', translation: 'so-so / عادي' },
    { emoji: '❓', pinyin: 'zěnmeyàng', text: '怎么样', translation: 'how / كيف' }
  ],
  ...
  keySentences: [
    {
      ...
      translation: 'She speaks Chinese very well. / هي تتحدث الصينية بشكل جيد جدًا.'
    },
    {
      tokens: [
  ...
  readings: {
    A: {
      ...
      translation: 'She speaks Chinese very well. He sings very well. She dances very well. He plays football pretty well.',
      tip: 'Reading Goal: Read the skill first, then read how well someone does it.',
      lines: [
        {
          tokens: [
            { py: 'Tā', hz: '她', cls: 'person' },
        ...
        },
        {
          ...
          translation: 'He sings very well. / هو يغني بشكل جيد جدًا.'
        },
        {
          tokens: [
            { py: 'Tā', hz: '她', cls: 'person' },
          ...
          translation: 'She dances very well. / هي ترقص بشكل جيد جدًا.'
        },
        {
          tokens: [
            { py: 'Tā', hz: '他', cls: 'person' },
          ...
          translation: 'He plays football pretty well. / هو يلعب كرة القدم بشكل لا بأس به.'
        }
      ]
    },
    ...
    B: {
      ...
      lines: [
        ...
        },
        {
          ...
          translation: 'I speak Chinese very well. / أتحدث الصينية بشكل جيد جدًا.'
        },
        {
          tokens: [
            { py: '', hz: '👦', cls: 'speaker' },
    ...
    C: {
      ...
      translation: 'My friend is Aisha. She dances very well. She can also sing, and she sings beautifully. My friend Fatima speaks Chinese very well.',
      ...
      lines: [
        {
          ...
          translation: 'My friend is Aisha. / صديقتي اسمها عائشة.'
        },
        {
          tokens: [
            { py: 'Tā', hz: '她', cls: 'person' },
          ...
          translation: 'She dances very beautifully. / هي ترقص بشكل جميل جدًا.'
        },
        {
          tokens: [
            { py: 'Tā', hz: '她', cls: 'person' },
          ...
          translation: 'She can also sing, and she sings beautifully. / تستطيع أيضًا الغناء، وهي تغني بصوت جميل جدًا.'
        },
        {
          tokens: [
            { py: 'Wǒ de péngyou', hz: '我的朋友', cls: 'person' },
          ...
          translation: 'My friend is Fatima. / صديقتي اسمها فاطمة.'
        },
        {
          tokens: [
            { py: 'Tā', hz: '她', cls: 'person' },
  ...
  meanings: {
    ...
    '很好看': 'very beautiful to watch / جميل جدًا للمشاهدة',
    '很好听': 'very pleasant to hear / جميل جدًا للاستماع',
